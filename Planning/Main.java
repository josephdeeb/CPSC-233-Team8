...
public class Main {
    ...
    public static void game(int x, int y) {
        ...
        // G
        drawLine(x+1, x+3, y, y, Color.RED);
        drawLine(x, x, y+1, y+5, Color.RED);
        drawLine(x+1, x+4, y+6, y+6, Color.RED);
        drawLine(x+4, x+4, y+3, y+5, Color.RED);
        drawLine(x+2, x+4, y+3, y+3, Color.RED);
        labels[x+4][y+1].colorUpdate(Color.RED);
        // A
        drawLine(x+6, x+6, y+1, y+6, Color.RED);
        drawLine(x+10, x+10, y+1, y+6, Color.RED);
        drawLine(x+7, x+9, y, y, Color.RED);
        drawLine(x+7, x+9, y+3, y+3, Color.RED);
        // M
        drawLine(x+12, x+12, y, y+6, Color.RED);
        drawLine(x+16, x+16, y, y+6, Color.RED);
        drawLine(x+14, x+14, y+1, y+3, Color.RED);
        labels[x+13][y].colorUpdate(Color.RED);
        labels[x+15][y].colorUpdate(Color.RED);
        // E
        drawLine(x+18, x+18, y, y+6, Color.RED);
        drawLine(x+18, x+22, y, y, Color.RED);
        drawLine(x+18, x+21, y+3, y+3, Color.RED);
        drawLine(x+18, x+22, y+6, y+6, Color.RED);
    }
    ...
    public static void over(int x, int y) {
        ...
        drawLine(x+1, x+3, y, y, Color.RED);
        drawLine(x, x, y+1, y+5, Color.RED);
        drawLine(x+1, x+3, y+6, y+6, Color.RED);
        drawLine(x+4, x+4, y+1, y+5, Color.RED);
        // V
        drawLine(x+6, x+6, y, y+4, Color.RED);
        drawLine(x+10, x+10, y, y+4, Color.RED);
        labels[x+7][y+5].colorUpdate(Color.RED);
        labels[x+8][y+6].colorUpdate(Color.RED);
        labels[x+9][y+5].colorUpdate(Color.RED);
        // E
        drawLine(x+12, x+12, y, y+6, Color.RED);
        drawLine(x+12, x+16, y, y, Color.RED);
        drawLine(x+12, x+15, y+3, y+3, Color.RED);
        drawLine(x+12, x+16, y+6, y+6, Color.RED);
        // R
        drawLine(x+18, x+18, y, y+6, Color.RED);
        drawLine(x+18, x+21, y, y, Color.RED);
        drawLine(x+18, x+21, y+3, y+3, Color.RED);
        drawLine(x+22, x+22, y+1, y+2, Color.RED);
        labels[x+20][y+4].colorUpdate(Color.RED);
        labels[x+21][y+5].colorUpdate(Color.RED);
        labels[x+22][y+6].colorUpdate(Color.RED);
    }
